...
Usage:  izapple2 [file]
  ...
  -s4 string
    	slot 4 configuration. (default "mockingboard")
  -s5 string
...
The available cards are:
  ...
  forthrom: Firmware card with Forth. It replaces the Basic ROM
  ...
  mockingboard: Mockingboard sound card with two AY-3-8913 sound generators
