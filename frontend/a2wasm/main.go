...
func ebitenRun(a *izapple2.Apple2) {
	...
	title := "iz-" + a.Name + " WebAssembly (F1 for help)"
	...
	// Setup disk loader JavaScript bridge
	setupDiskLoader(a)
...
Use the file picker buttons or drag & drop
disk images to load them into drives
